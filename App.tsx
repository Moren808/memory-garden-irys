...
const App: React.FC = () => {
  ...
  const animatedTreesRef = useRef<Map<string, any>>(new Map()); // Added this ref to be accessible
  ...
  const handleClearGarden = useCallback(() => {
    ...
    // The GardenCanvas component will handle clearing the trees when the prop is updated.
